...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post libraries_url, params: { library: { book_id: @library.book_id, user_id: @library.user_id } }, as: :json
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { book_id: @library.book_id, user_id: @library.user_id } }, as: :json
    assert_response 200
  end
